...
import { PanelAdminAsideLinks } from '@/components/page/panel/admin/layout/PanelAdminAsideLinks';
...
export default function DashboardLayout({
  ...
  return (
    <main className='flex h-screen'>
      <aside className='flex w-full basis-1/5 flex-col justify-between p-8'>
        <div>
          <DropdownMenu>
            ...
            <DropdownMenuContent className='ml-4 mt-3 w-[300px] p-5'>
              <div className='flex flex-col gap-4'>
                <Link className='flex items-center gap-2' href='/panel'>
                  <User /> Área de Membros
                </Link>
          ...
          <PanelAdminAsideLinks />
        </div>
        <p className='block w-full text-center text-neutral-400'>
