...
export const Footer = () => {
  ...
  const navLinks = [
    ...
    { label: t('nav_about'), href: '#sobrenos' },
    { label: t('nav_faq'), href: '#faq' },
  ];

  const legalLinks = [
    { label: t('legal_terms'), href: '/termos-de-uso' },
    { label: t('legal_privacy'), href: '/politica-de-privacidade' },
    { label: t('legal_notice'), href: '/aviso-legal' },
    { label: t('legal_refund'), href: '/politica-de-reembolso' },
  ];

  const statPills = [t('stat1'), t('stat2'), t('stat3')];
            ...
            <div>
              ...
              <div className='flex flex-col gap-3'>
                ...
                <Link
                  ...
                  className='group inline-flex items-center gap-2.5 text-sm text-neutral-400 transition-colors hover:text-white'
                >
                  <Instagram className='h-3.5 w-3.5 shrink-0 text-neutral-600 transition-colors group-hover:text-theme-400' />
                  @upboost_
                </Link>
              </div>
            </div>
